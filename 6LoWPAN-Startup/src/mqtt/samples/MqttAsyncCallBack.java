...
public class MqttAsyncCallBack implements MqttCallback {
	...
	public static void main(String[] args) {
		...
		int qos 			= 2;
		String broker 		= "192.168.2.100";
		int port 			= 1883;
		String clientId 	= null;
		String subTopic		= "vestel/newDevice/#";
		String pubTopic 	= "vestel/newDevice/10002";
		...
		try {
			...
			MqttAsyncCallBack sampleClient = new MqttAsyncCallBack(url,clientId,cleanSession, quietMode,userName,password);
	...
	public static void applyTraining(String devId, String dimLvl){

		// Default settings:
		boolean quietMode 	= false;
		String action 		= "publish";
		String topic 		= "";
		String message 		= dimLvl;
		int qos 			= 2;
		String broker 		= "192.168.2.42";
		int port 			= 1883;
		String clientId 	= null;
		String subTopic		= "vestel/device/#";
		String pubTopic 	= "vestel/device/"+devId+"/dim";
		boolean cleanSession = true;			// Non durable subscriptions
		boolean ssl = false;
		String password = null;
		String userName = null;
	...
	// V> Start - Unique for SampleAsyncCallBack class
	Throwable 			ex = null;
	Object 				waiter = new Object();
	boolean 			donext = false;
	// V> End - Unique for SampleAsyncCallBack class
