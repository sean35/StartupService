...
public class MqttAsyncWait implements MqttCallback {
	...
	public static void main(String[] args) {
		...
		String pubTopic 	= "vestel/device/10002/dim";
		...
		try {
			...
			MqttAsyncWait sampleClient = new MqttAsyncWait(url,clientId,cleanSession, quietMode,userName,password);
	 ...
	 */
    public MqttAsyncWait(String brokerUrl, String clientId, boolean cleanSession,
